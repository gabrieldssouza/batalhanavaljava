...
public class Main {
    ...
    private static void jogarSingleplayer() {
        ...
        while (!jogoAcabou(tabuleiroJogador, tabuleiroComputador)) {
            ...
            qntdBarcosJogador = fazerJogada(tabuleiroComputador, tabuleiroCensurado, qntdBarcosJogador, 1);
            ...
            qntdBarcosComputador = fazerJogadaComputador(tabuleiroJogador, qntdBarcosComputador, 2);
    ...
    private static void jogarMultiplayer() {
        ...
        while (!jogoAcabou(tabuleiroJogador, tabuleiroComputador)) {
            ...
            qntdBarcosJogador1 = fazerJogada(tabuleiroComputador, tabuleiroCensurado, qntdBarcosJogador1, 3);
            ...
            qntdBarcosJogador2 = fazerJogada(tabuleiroJogador, tabuleiroCensurado, qntdBarcosJogador2, 4);
    ...
    private static int fazerJogadaComputador(String[][] tabuleiro, int qntdBarcosComputador, int jogador) {
        int jogadade = jogador;
        Random random = new Random();
        int linha;
        int coluna;
